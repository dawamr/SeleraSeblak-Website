...
import { Menu, Clock, MapPin, Phone, Instagram, Facebook, PiIcon as ChiliIcon, Smartphone, Handshake, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1626804475297-41608ea09aeb?auto=format&fit=crop&q=80"
            alt="Spicy Food"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white">
            <h1 className="text-5xl md:text-7xl font-bold mb-4">Pedas Nikmat<br />Setiap Gigitan</h1>
